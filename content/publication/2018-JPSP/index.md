...
abstract: "Many of society’s most significant social decisions are made over sets of individuals: for example,
...
candidate as a function of the other candidates in the choice set (Experiments 1a–1d, 2) and the
...
links:
- name: Psyarxiv
  url: https://psyarxiv.com/yaevr/
- name: OSF
  url: https://osf.io/eg6w5/
  icon_pack: ai
  icon: osf
