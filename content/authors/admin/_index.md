...
- icon: envelope
  icon_pack: fas
  link: 'mailto:lindachang@g.harvard.edu'  # For a direct email link, use "mailto:test@example.org".
- icon: twitter
  icon_pack: fab
  link: http://twitter.com/iamlindachang
- icon: osf
  icon_pack: ai
  link: http://osf.io/jx6tz
- icon: github
  icon_pack: fab
  link: https://github.com/iamlindachang  
- icon: orcid
  icon_pack: ai
  link: https://orcid.org/0000-0002-2529-2519
- icon: google-scholar
  icon_pack: ai
  link: https://scholar.google.com/citations?user=2Eyc-VAAAAAJ
